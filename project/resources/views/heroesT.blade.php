...
<header class="dark-header">
  ...
  <section class="hero-images-section">
    <div class="container">
      <h2>Explore Dota 2 Heroes Images</h2>
      <div class="hero-images">
        <!-- Hero images content goes here -->
        <div class="hero-image-card">
          <img src="asset/images/3.png" alt="Hero 1">
          <h3>Crystal Maiden</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/4.png" alt="Hero 2">
          <h3>Dark Willow</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/5.png" alt="Hero 3">
          <h3>Dawn Breaker</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/6.png" alt="Hero 4">
          <h3>Death Prophet</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/7.png" alt="Hero 5">
          <h3>Drow Ranger</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/8.png" alt="Hero 6">
          <h3>Enchantres</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/9.png" alt="Hero 7">
          <h3>Hood Wink</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/10.png" alt="Hero 8">
          <h3>Lina</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/11.png" alt="Hero 9">
          <h3>Luna</h3>
        </div>
        <div class="hero-image-card">
          <img src="asset/images/12.png" alt="Hero 10">
          <h3>Marci</h3>
        </div>
      </div>
    </div>
  ...
  <section class="hero-details-section">
    <div class="container">
      <div class="hero-details">
        <!-- Hero details content goes here -->
      </div>
    </div>
  </section>
  @show
...
<section class="latest-news-section">
    <div class="container">
      ...
      <div class="news-highlights">
        <div class="news">
          <img src="asset/images/111.jpg" alt="News Image 1">
        ...
        <div class="news">
          <img src="asset/images/222.jpg" alt="News Image 2">
          <div class="news-content">
    ...
    <div class="container">
      ...
      <div class="social-media">
        ...
        <div class="social-icons">
          <a href="https://www.facebook.com/profile.php?id=61554736177114" class="social-icon"><img src="asset/images/14.png" alt="Facebook"></a>
          <a href="https://github.com/germanybasillo/siaproje" class="social-icon"><img src="asset/images/13.png" alt="Github"></a>
    ...
    <div class="container">
      <div class="footer-content">
        <div class="contact-info">
          ...
          <p>Email: germanylungay@dota2universe.com</p>
          <p>Phone: +93 9944398759</p>
          <p>Address: Purok papaya la union, GameCity</p>
        </div>
