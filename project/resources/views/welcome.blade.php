...
<header class="dark-header">
    ...
    @show
    <div class="drow">
      <!-- You can use either an image or a video here -->
      <!-- Image Example: -->
      <img src="asset/images/1.webp" alt="Dota 2 Hero" class="hero-image">
      <!-- Video Example (uncomment and replace with your video source): -->
